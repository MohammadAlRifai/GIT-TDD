...
const catsList = new Schema({
  catName: String,
  ownerEmail: String,
  imageUrl: String,
  adoptionMessage: String
});
//Create a nconst Name = mongoose.model('Name', catsList);
//new collection called 'Name'
...
describe('Test Database', function() {
  ...
  //  it('Should retrieve data from catsList database', function(done) {
